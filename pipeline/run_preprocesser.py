...
for file in glob.glob("{}*.csv".format(constants.RAW_DATA_PATH)):
    ...
    output_path_tokenized = constants.TOKENIZED_DATA_PATH + file.split("\\")[-1] + '_tokenized.pkl'
    ...
    output_path_preprocessed = constants.PREPROCESSED_DATA_PATH + file.split("\\")[-1] + '_preprocessed.pkl'
